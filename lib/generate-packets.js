...
const triggers = [triggerNamedEntitySpawn, triggerTabComplete, triggerChat, triggerRespawn, triggerGameStateChange, triggerSetCooldown, triggerMap]
...
async function triggerMap (server, bot) {
  bot.chat('/gamemode survival')
